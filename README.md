...
| La Ciénaga Turbia | Desagrado (rechazo social y moral) | cámara fija | **rechazar la conducta, no a la persona** | Menú de la isla con dos minijuegos independientes, en cualquier orden. En los dos, una sola línea de guía abajo dice qué toca hacer y ahí mismo se lee el resultado (sin notas ni rótulos sueltos). **La Cadena** (tiempo real, 5 rondas): eres el nodo central de una red sobre la ciénaga por la que corren mensajes. Empieza con una práctica guiada de cuatro mensajes (uno cada vez, quietos, con pistas animadas). Tocar un mensaje abre cuatro botones —cortar, responder, pedir ayuda, dejar pasar—; los gestos son atajos: arrastrar cruzando el hilo corta, mantener pulsado tu nodo abre el eco (tres frases: asertiva, agresiva o evasiva) y arrastrar el paquete a la baliza pide ayuda. Dejar pasar replica a 2-3 nodos y enturbia el agua. Un tercio son *trampas*: diferencias que dan grima pero no hacen daño; cortarlas penaliza. HUD de claridad del agua, coherencia con los valores declarados y termómetro de desagrado. La última ronda trae un mensaje sobre ti. **El Separador** (sin cronómetro): 10 grumos —escenas envueltas en una sustancia oscura— que se escuchan, se separan frotando (con resistencia y progreso en la guía), se clasifican en «Esto rechazo» (y se nombra la conducta), «Esta persona» o «Aquí no hay daño, hay diferencia» —tocando la pieza salen los tres contenedores como botones, o se arrastra y el destino se ilumina—, y cierran eligiendo un paso real que va al diario de límites. Los últimos son dilemas sin respuesta única. Cada juego termina con su reevaluación; la isla se cierra con el diario cuando están los dos |
...
│   ├── disgust/DisgustIslandFlow.js (menú) · CadenaGame.js · SeparadorGame.js · cienaga.js (escenario, guía, pistas)
│   │   └── IslaTextos.js · CadenaTextos.js · SeparadorTextos.js   todos los textos editables

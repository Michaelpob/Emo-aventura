...
| La Cordillera de los Nudos | Frustración | cámara fija | **tolerar la frustración** (fallo guionizado, reversible, sin castigo) | Nivel 1, **La Máquina Terca**: puzzle de ensamblaje en el taller del molino (arrastrar piezas y girarlas con dos botones) en tres rondas: la fácil, la que no entra (la pieza obvia está doblada y nunca entra; tras dos rebotes aparecen «Probar otra pieza» / «Pedirle una idea a Tuerca»: la solución es otra pieza más pequeña girada 90°) y el engranaje que solo gira despacio y seguido. Un manómetro de tensión sube con rebotes, clics rápidos, piezas forzadas y tiempo sin avanzar, y el taller lo devuelve en el cuerpo (vibración, vapor, latido, tinte); al 100, bloqueo de 3 s y la caja de calma (respirar 4-4-4, contar 5 a 1, pedir ayuda, cambiar de plan). Cierre con reevaluación 1-5, feedback según los datos reales y reto. Recompensa: Llave de Engranaje. Nivel 2, **El Volcán de la Presión**: acción en tiempo real; la presión sube sola y hay tres válvulas (respirar con el anillo, transformar pensamientos trampa tocándolos, cuerda de ayuda) y un botón rojo ¡GOLPEAR! que alivia un segundo y luego cobra; tres oleadas (burbujas, la grieta que solo sella respirando dos veces seguidas, la meta que se mueve); el desborde es una erupción cómica y se sigue al 50 %; escalado adaptativo al segundo desborde. Cierre con válvula de la semana e insignia Guardián de la Presión. Tuerca acompaña los dos niveles; textos en `textos.js`; JSON de sesión (`gameState.sessions`, evento `emo-sesion`) |
...
│   ├── disgust/DisgustSortGame.js     frustration/MaquinaTercaGame.js + VolcanPresionGame.js (+ FrustrationIslandFlow.js,
│   │                                   TensionMeter.js, CalmToolbox.js, Tuerca.js, textos.js)

...
| El lago sereno | Calma | 1ª persona | **escuchar y bajar el ritmo** | Tres actividades en orden, cada una en su rincón: el lago espejo (sentado en el muelle, el agua revuelta se aquieta con cada exhalación hasta reflejar el cielo), los pájaros escondidos (cinco pájaros del bosque que solo cantan si te quedas quieto; se localizan escuchando y mirando hacia el canto, y vienen a posarse cerca) y el estanque musical (nenúfares que son notas de kalimba en pentatónica: pisándolos se compone una melodía propia que la piedra del eco devuelve). Música generativa que gana capas y sonidos de agua, arroyo, hojas, campanas y cinco cantos distintos |

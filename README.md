...
| Guardianes del Desagrado | Asco | 1ª persona | **reconocer, medir y responder** | Recorrido en orden, cada actividad en su propio entorno: termómetro (se sube por terrazas y cambia el mundo), dos zonas donde los estímulos se responden con el cuerpo (alejarse = sí me genera desagrado), Espejo de las Reacciones (pisar baldosas), las herramientas que tocan según el nivel (leve 1, moderado 2, intenso 3: burbuja de respiración, mariposas con la mirada, cargar la sensación por tres arcos, 5-4-3-2-1 con un modo por sentido, puertas del pensamiento, llamar al Guardián), reevaluación y La Reacción Impulsiva, que crece si corres, saltas o chocas y se encoge con los altares de lo aprendido |

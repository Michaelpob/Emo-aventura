...
| Guardianes del Desagrado | Asco | — | **en construcción** | La isla se vació el 2026-09-21 para rehacerla con nuevos juegos; de momento muestra un marcador "en construcción". La versión anterior queda en el historial de git (`git show d1af75e:src/minigames/disgust/DisgustTerritoryGame.js`) |
